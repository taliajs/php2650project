...
We will demonstrate how sampling methods and variational inference can be implemented. 
...
This dataset contains information on 8 different components/features used to make concrete for 1,030 concrete samples, with the outcome of interest being concrete compressive strength. All the variables are quantitative. 
