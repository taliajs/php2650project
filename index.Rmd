...
Approximating the posterior through variational methods is done through a way where the learning the approximation of a posterior scales better than the MCMC algorithm [2]. Variational methods model the posterior *p(w|D)* using a parametrized distribution, <img src = "https://render.githubusercontent.com/render/math?math=q_\phi(w)"> called the **approximate posterior** (which is a “parametrized, tractable-stand in distribution” [1]) (The parametrized variational distribution over the weights [img src = "https://render.githubusercontent.com/render/math?math=q_\phi(w)"> is specified). 
