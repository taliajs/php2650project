...
Bayes by Backpropagation is a backpropagation algorithm that is used for learning a probability distribution on the weights of a neural network [4]. This algorithm implements stochastic variational inference and regularizes the weights by minimizing the loss function. 
