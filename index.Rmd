...
First, we will implement a Bayesian neural network using variational inference for a sine function: *1.5sin* <img src = "https://render.githubusercontent.com/render/math?math=x^{2}">. We fit a Bayesian neural network with 3 layers, with a prior of 0.1, using a feed-forward approach. 
