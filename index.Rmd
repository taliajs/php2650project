...
First, we will implement a Bayesian neural network using variational inference for a sine function: <img src= "https://render.githubusercontent.com/render/math?math=1.5x^{2}">
