...
2. Generate proposal distribution for [**theta^p**], which incorporates the model weights and <img src = "https://render.githubusercontent.com/render/math?math=\tau^2"> from a Langevin gradient or random walk proposal distribution. 
