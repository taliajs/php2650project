...
Normally, a neural networks aims to use the training data [**INSERT D_train** as a mathematical formula with subscript] to update the weight parameters https://render.githubusercontent.com/render/math?math=w so as to maximize a loss function []. 
