...
We will implement variational and sampling methods on this concrete linear regression dataset. 
...
For implementing MCMC, we used an algorithm from Chandra et al that used Langevin-based MCMC sampling on a Bayesian neural network framework [6]. 
