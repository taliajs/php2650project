...
Normally, a neural networks aims to use the training data <img src = "img/training-data.png" width = "50"/> to update the weight parameters <img src = "https://render.githubusercontent.com/render/math?math=w"> so as to maximize a loss function *L(w)*. A neural network through the Bayesian approach aims to estimate the posterior distribution <img src = "img/posterior-distribution.png" width = "50"/>,the distribution of the weight parameters given the training data the model is fitted with [1]. 
