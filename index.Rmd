...
Normally, a neural networks aims to use the training data <img src="https://render.githubusercontent.com/render/math?math={[D_{train}ln(O_{j})}">

[**INSERT D_train** as a mathematical formula with subscript] 

to update the weight parameters <img src = "https://render.githubusercontent.com/render/math?math=w"> so as to maximize a loss function <img src = "https://render.githubusercontent.com/render/math?math={L(w)}". A neural network through the Bayesian approach aims to estimate the posterior distribution (**INSERT EQUATION HERE**), the distribution of the weight parameters given the training data the model is fitted with [1]. 
